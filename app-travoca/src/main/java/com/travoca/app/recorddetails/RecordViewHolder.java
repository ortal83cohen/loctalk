        ...
        if (record.imageUrl != null) {
            ...
            mSnippetImagePager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
                ...
                public void onPageSelected(int position) {
                    mNumberImages.setText(
                            new StringBuilder().append(String.valueOf(position + 1)).append("/")
                                    .append(String.valueOf(imagesPagerAdapter.getCount()))
                                    .toString());
                }
            ...
            mNumberImages.setText(new StringBuilder().append("1/")
                    .append(String.valueOf(imagesPagerAdapter.getCount())).toString());
        }

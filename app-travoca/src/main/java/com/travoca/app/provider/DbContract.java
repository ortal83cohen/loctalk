...
public interface ServiceGpsRequestsColumns {
    ...
    public static class Favorites implements FavoritesColumns, BaseColumns {
        ...
        public static Uri buildRecordUri(String recordId, String city, String country) {
            return CONTENT_URI.buildUpon().appendPath(recordId).appendPath(city).appendPath(country)
                    .build();
        }
    ...
    public static class SearchHistory implements SearchHistoryColumns, BaseColumns {
        ...
        public static Uri buildSearchHistoryUri(String location, String lat, String lon,
                String northeastLat, String northeastLon, String southwestLat, String southwestLon,
                String types) {
            return CONTENT_URI.buildUpon().appendPath(location).appendPath(lat).appendPath(lon)
                    .appendPath(northeastLat).appendPath(northeastLon).appendPath(southwestLat)
                    .appendPath(southwestLon).appendPath(types).build();
        }

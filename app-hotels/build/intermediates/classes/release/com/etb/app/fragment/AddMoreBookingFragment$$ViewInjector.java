...
public class AddMoreBookingFragment$$ViewInjector<T extends com.etb.app.fragment.AddMoreBookingFragment> implements Injector<T> {
    ...
    public void inject(final Finder finder, final T target, Object source) {
        View view;
        view = finder.findRequiredView(source, 2131624137, "field 'mBookingNumber'");
        target.mBookingNumber = finder.castView(view, 2131624137, "field 'mBookingNumber'");
        view = finder.findRequiredView(source, 2131624122, "field 'mPassword'");
        target.mPassword = finder.castView(view, 2131624122, "field 'mPassword'");

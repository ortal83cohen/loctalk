...
public class HotelDetailsActivity$$ViewBinder<T extends com.etb.app.activity.HotelDetailsActivity> extends com.etb.app.activity.TabActivity$$ViewBinder<T> {
    ...
    public void bind(final Finder finder, final T target, Object source) {
        ...
        View view;
        view = finder.findRequiredView(source, 2131689617, "field 'mAllRoomsButton' and method 'onClickAvailableRooms'");
        target.mAllRoomsButton = finder.castView(view, 2131689617, "field 'mAllRoomsButton'");
        ...
        view = finder.findRequiredView(source, 2131689616, "field 'mShowLandmarks' and method 'onClickShowLandmarks'");
        target.mShowLandmarks = finder.castView(view, 2131689616, "field 'mShowLandmarks'");
        view.setOnClickListener(
                new butterknife.internal.DebouncingOnClickListener() {
                    @Override
                    public void doClick(

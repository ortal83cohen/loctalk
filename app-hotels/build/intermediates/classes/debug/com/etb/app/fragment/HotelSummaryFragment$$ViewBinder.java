...
public class HotelSummaryFragment$$ViewBinder<T extends com.etb.app.fragment.HotelSummaryFragment> implements ViewBinder<T> {
    ...
    public void bind(final Finder finder, final T target, Object source) {
        ...
        view = finder.findRequiredView(source, 2131624254, "field 'mFacilitiesBox'");
        target.mFacilitiesBox = view;
        view = finder.findRequiredView(source, 2131624256, "field 'mReviewsBox'");
        target.mReviewsBox = view;
        view = finder.findRequiredView(source, 2131624191, "field 'mRoomView'");
        target.mRoomView = finder.castView(view, 2131624191, "field 'mRoomView'");

...
public class PoisFilterFragment$$ViewBinder<T extends com.etb.app.fragment.PoisFilterFragment> implements ViewBinder<T> {
    ...
    public void bind(final Finder finder, final T target, Object source) {
        View view;
        view = finder.findRequiredView(source, 2131624236, "field 'mPoisTypesList'");
        target.mPoisTypesList = finder.castView(view, 2131624236, "field 'mPoisTypesList'");
        ...
        view = finder.findRequiredView(source, 2131624235, "field 'mPoiMassage'");
        target.mPoiMassage = finder.castView(view, 2131624235, "field 'mPoiMassage'");
    }

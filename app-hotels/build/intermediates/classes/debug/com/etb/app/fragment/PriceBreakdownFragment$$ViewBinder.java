...
public class PriceBreakdownFragment$$ViewBinder<T extends com.etb.app.fragment.PriceBreakdownFragment> implements ViewBinder<T> {
    ...
    public void bind(final Finder finder, final T target, Object source) {
        ...
        view = finder.findRequiredView(source, 2131624241, "field 'mCloseButton'");
        target.mCloseButton = finder.castView(view, 2131624241, "field 'mCloseButton'");
        view = finder.findRequiredView(source, 2131624237, "field 'mRoomText'");
        target.mRoomText = finder.castView(view, 2131624237, "field 'mRoomText'");
        view = finder.findRequiredView(source, 2131624238, "field 'mRoomValue'");
        target.mRoomValue = finder.castView(view, 2131624238, "field 'mRoomValue'");
        ...
        view = finder.findRequiredView(source, 2131624239, "field 'mDiscountValue'");
        target.mDiscountValue = finder.castView(view, 2131624239, "field 'mDiscountValue'");
        view = finder.findRequiredView(source, 2131624240, "field 'mTaxValue'");
        target.mTaxValue = finder.castView(view, 2131624240, "field 'mTaxValue'");

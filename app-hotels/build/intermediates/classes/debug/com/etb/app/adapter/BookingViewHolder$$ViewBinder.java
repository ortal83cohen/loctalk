...
public class BookingViewHolder$$ViewBinder<T extends com.etb.app.adapter.BookingViewHolder> implements ViewBinder<T> {
    ...
    public void bind(final Finder finder, final T target, Object source) {
        ...
        view = finder.findRequiredView(source, 2131624261, "field 'mCity'");
        target.mCity = finder.castView(view, 2131624261, "field 'mCity'");
        view = finder.findRequiredView(source, 2131624262, "field 'mCountry'");
        target.mCountry = finder.castView(view, 2131624262, "field 'mCountry'");
        ...
        view = finder.findRequiredView(source, 2131624263, "field 'mManageButton'");
        target.mManageButton = finder.castView(view, 2131624263, "field 'mManageButton'");

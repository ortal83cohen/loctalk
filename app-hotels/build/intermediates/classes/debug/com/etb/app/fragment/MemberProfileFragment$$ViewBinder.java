...
public class MemberProfileFragment$$ViewBinder<T extends com.etb.app.fragment.MemberProfileFragment> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131624270, "field 'mProfileImage'");
    target.mProfileImage = finder.castView(view, 2131624270, "field 'mProfileImage'");
    ...
    view = finder.findRequiredView(source, 2131624271, "field 'mEditButton'");
    target.mEditButton = finder.castView(view, 2131624271, "field 'mEditButton'");
  }

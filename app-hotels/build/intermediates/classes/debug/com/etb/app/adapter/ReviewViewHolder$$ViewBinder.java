...
public class ReviewViewHolder$$ViewBinder<T extends com.etb.app.adapter.ReviewViewHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624301, "field 'mPurpose'");
    target.mPurpose = finder.castView(view, 2131624301, "field 'mPurpose'");
    view = finder.findRequiredView(source, 2131624302, "field 'mDate'");
    target.mDate = finder.castView(view, 2131624302, "field 'mDate'");
    ...
    view = finder.findRequiredView(source, 2131624265, "field 'mRatingBar'");
    target.mRatingBar = finder.castView(view, 2131624265, "field 'mRatingBar'");
    view = finder.findRequiredView(source, 2131624266, "field 'mRating'");
    target.mRating = finder.castView(view, 2131624266, "field 'mRating'");
  }

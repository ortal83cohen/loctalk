...
public class HotelsListFragment$$ViewBinder<T extends com.etb.app.fragment.HotelsListFragment> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624189, "field 'mButtonSort'");
    target.mButtonSort = finder.castView(view, 2131624189, "field 'mButtonSort'");
    ...
    view = finder.findRequiredView(source, 2131624188, "field 'mTopPanel'");
    target.mTopPanel = finder.castView(view, 2131624188, "field 'mTopPanel'");
    view = finder.findRequiredView(source, 2131624190, "field 'mAvailableCountText'");
    target.mAvailableCountText = finder.castView(view, 2131624190, "field 'mAvailableCountText'");
    ...
    view = finder.findRequiredView(source, 2131624314, "field 'mFiltersText'");
    target.mFiltersText = finder.castView(view, 2131624314, "field 'mFiltersText'");

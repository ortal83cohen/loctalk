...
public class HotelDetailsActivity$$ViewInjector<T extends com.etb.app.activity.HotelDetailsActivity> extends com.etb.app.activity.TabActivity$$ViewInjector<T> {
    ...
    public void inject(final Finder finder, final T target, Object source) {
        ...
        View view;
        view = finder.findRequiredView(source, 2131624086, "field 'mAllRoomsButton' and method 'onClickAvailableRooms'");
        target.mAllRoomsButton = finder.castView(view, 2131624086, "field 'mAllRoomsButton'");
        ...
        view = finder.findRequiredView(source, 2131624085, "field 'mShowLandmarks' and method 'onClickShowLandmarks'");
        target.mShowLandmarks = finder.castView(view, 2131624085, "field 'mShowLandmarks'");
        view.setOnClickListener(
                new butterknife.internal.DebouncingOnClickListener() {
                    @Override
                    public void doClick(

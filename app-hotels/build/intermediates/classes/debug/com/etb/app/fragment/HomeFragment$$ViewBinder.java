...
public class HomeFragment$$ViewBinder<T extends com.etb.app.fragment.HomeFragment> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624185, "field 'mNumberPersonsSelector'");
    target.mNumberPersonsSelector = finder.castView(view, 2131624185, "field 'mNumberPersonsSelector'");
    view = finder.findRequiredView(source, 2131624186, "field 'mNumberRoomsSelector'");
    target.mNumberRoomsSelector = finder.castView(view, 2131624186, "field 'mNumberRoomsSelector'");
    view = finder.findRequiredView(source, 2131624184, "field 'mRoomsButton'");
    target.mRoomsButton = finder.castView(view, 2131624184, "field 'mRoomsButton'");
    view = finder.findRequiredView(source, 2131624181, "field 'mCheckInButton'");
    target.mCheckInButton = finder.castView(view, 2131624181, "field 'mCheckInButton'");
    view = finder.findRequiredView(source, 2131624182, "field 'mCheckOutButton'");
    target.mCheckOutButton = finder.castView(view, 2131624182, "field 'mCheckOutButton'");
    view = finder.findRequiredView(source, 2131624183, "field 'mPersonsButton'");
    target.mPersonsButton = finder.castView(view, 2131624183, "field 'mPersonsButton'");
    view = finder.findRequiredView(source, 2131624172, "field 'mDatePicker'");
    target.mDatePicker = finder.castView(view, 2131624172, "field 'mDatePicker'");
    ...
    view = finder.findRequiredView(source, 2131624187, "field 'mSearchHotelsButton' and method 'onSearchHotelsClick'");
    target.mSearchHotelsButton = finder.castView(view, 2131624187, "field 'mSearchHotelsButton'");
